...
#' gspline(c(0, 1, 2), 0, -1)}.
#' 
#' @aliases gspline print.gspline print.gspline_matrix knots.gspline
...
#' @param x an object of class \code{"gspline"} or \code{"gspline_matrix"} to
#' print.
...
#' @param show character vector with one or more of the elements of
#' \code{c("knots", "degree", "smoothness", "G", "constraint_mat",
#' "estimate_mat")} specifying items to display when printing a
#' spline-generating function produced by \code{gspline}.
#' @param Fn a spline-generating function returned by \code{gspline}.
#' @param ... not used, to match generics.
